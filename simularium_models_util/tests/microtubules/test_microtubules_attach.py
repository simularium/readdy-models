        ...
        (
            ...
            "Microtubule",
            {
                ...
                "particles": {
                    ...
                    25: {"unique_id": 25, "type_name": "site#out", "position": np.zeros(3), "neighbor_ids": [7, 26, 27, 28, 29, 20, 30]},
                    26: {"unique_id": 26, "type_name": "site#1", "position": np.zeros(3), "neighbor_ids": [7, 25, 28, 29, 21, 31]},
                    27: {"unique_id": 27, "type_name": "site#2", "position": np.zeros(3), "neighbor_ids": [7, 25, 28, 29, 22, 32]},
                    ...
                    30: {"unique_id": 30, "type_name": "site#out", "position": np.zeros(3), "neighbor_ids": [8, 31, 32, 33, 34, 25]},
                    31: {"unique_id": 31, "type_name": "site#1", "position": np.zeros(3), "neighbor_ids": [8, 30, 33, 34, 26]},
                    32: {"unique_id": 32, "type_name": "site#2", "position": np.zeros(3), "neighbor_ids": [8, 30, 33, 34, 27]},
                    ...
                    40: {"unique_id": 40, "type_name": "site#out", "position": np.zeros(3), "neighbor_ids": [12, 41, 42, 43, 44, 35, 45]},
                    41: {"unique_id": 41, "type_name": "site#1", "position": np.zeros(3), "neighbor_ids": [12, 40, 43, 44, 36, 46]},
                    42: {"unique_id": 42, "type_name": "site#2", "position": np.zeros(3), "neighbor_ids": [12, 40, 43, 44, 37, 47]},
                    ...
                    45: {"unique_id": 45, "type_name": "site#out", "position": np.zeros(3), "neighbor_ids": [13, 46, 47, 48, 49, 40]},
                    46: {"unique_id": 46, "type_name": "site#1", "position": np.zeros(3), "neighbor_ids": [13, 45, 48, 49, 41]},
                    47: {"unique_id": 47, "type_name": "site#2", "position": np.zeros(3), "neighbor_ids": [13, 45, 48, 49, 42]},
